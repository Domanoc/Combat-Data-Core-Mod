# ModFramework - Adding a mech object

#### [Back to overview](../Overview.md)
---

## Recommended usage
use in "obj_content_mechs.lua" in the create function, for when adding items to a new game.
...
## Notes
The function has a second param that is optional to set the mechs name in the inventory. When left nil it will pick one of the games default names.   
