...
## Managing placement
The framework Takes control of the placement for all shop components as long as these items either be found in the [game_obj_component_shop](../../../src/ModFramework/_GameDefinitions/Classes/game_obj_component_shop.lua) or are created by the framework.
