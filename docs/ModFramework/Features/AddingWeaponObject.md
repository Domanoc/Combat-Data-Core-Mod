# ModFramework - Adding a weapon object

#### [Back to overview](../Overview.md)
---

## Recommended usage
use in "obj_content_weapons.lua" in the create function, for when adding items to a new game.
...
## Notes
The second param is a flag to set the new weapon to be a +sized/huge weapon.   
