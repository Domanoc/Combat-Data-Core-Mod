...
---@alias LocalizationSections "WeaponDescription"|"ResearchDescription"|"PilotWorkExperience"|"ShopDescription"|"SettingsMenu"|"Custom" the sections for localization
