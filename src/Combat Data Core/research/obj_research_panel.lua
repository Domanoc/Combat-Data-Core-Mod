...
function GetModFramework()
    ...
    if (not ok or isLoaded ~= true) then
		...
		--Custom
		message = message..spacerLine.."The last update added the requirement for the ModFramework, if you want to keep playing using the old version. "
		message = message.."Then you can download it on the github page. \n\nSee the readme for the link."
